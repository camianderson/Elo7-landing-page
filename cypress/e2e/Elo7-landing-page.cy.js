describe("Página Carreiras", () => {
  ...
  it("Deve renderizar o paragrafo de descrição da página", () => {
    ...
    cy.contains(
      ".descrição",
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque ut efficitur ex, at malesuada ligula. Pellentesque odio ipsum, viverra a eros sit amet, fringilla sagittis auge. Fusce risus tellus, tempus quis lacinia in vehicula ut turpis."
    );
  });
  ...
  it("Deve renderizar o título, o nome do CEO e o parágrafo sobre o CEO", () => {
    ...
    cy.get(".CEO-descrição")
      ...
      .should(
        "contain",
        "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quisque ut efficitur ipsum risus gravida ex, at malesuada ligula. Pellentesque odio ipsum, viverra a eros sit amet, fringilla sagittis augue. Fusce risus tellus, tempus quis lacinia in, vehicula ut turpis."
      );
  });
  ...
  it("Deve renderizar a lista de benefícios", () => {
    cy.get(".benefícios-container--lista").children(".sessão").should("exist");
    ...
    cy.get(".benefícios-container--lista")
      ...
      .should(
        "contain",
        "Lorem, ipsum dolor sit amet, consectetur adipisicing elit. Quisque ut efficitur ipsum risus gravida ex, at malesuada ligula. Pellentesque odio ipsum,"
      );
    ...
    cy.get(".benefícios-container--lista")
      ...
      .should(
        "contain",
        "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque ut efficitur ex, at malesuada ligula. Pellentesque odio ipsum, viverra a eros sit amet, fringilla sagittis auge. Fusce risus tellus,"
      );
  });
  it("Deve renderizar o botão de saiba mais", () => {
    cy.get(".benefícios-container--btn").children(".separador").should("exist");
  ...
  it("Deve renderizar a imagem das vagas e o título", () => {
    cy.get(".vagas-container").children(".foto-vagas").should("exist");
